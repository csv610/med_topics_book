...
Japanese encephalitis (JE) is a viral infection of the brain caused by Japanese encephalitis virus, spread to humans by infected mosquitoes, mainly of the Culex species. It occurs across much of Asia and the western Pacific. Most infected people have no symptoms or a mild illness, but a minority develop encephalitis with fever, headache, confusion, seizures, or paralysis; severe disease can cause death or lasting disability. There is no specific antiviral treatment, so vaccination where recommended and avoiding mosquito bites are important.

\section*{Epidemiology}
Japanese encephalitis is an important cause of viral encephalitis in Asia and the western Pacific. It mainly affects children in endemic areas, although adults can be affected when they lack immunity. The virus is maintained between pigs and wading birds by Culex mosquitoes; humans are infected when bitten near these transmission cycles. Travel and vaccination recommendations depend on destination, season, length of stay, and activities.

\section*{Aetiology and Pathophysiology}
The Japanese encephalitis virus is a flavivirus, related to dengue, Zika, and West Nile viruses. It is transmitted when a Culex mosquito, usually Culex annulirostris in many countries, bites an infected animal, most often pigs or waterbirds, and then bites a human. The virus multiplies in the skin and lymph nodes and spreads through the blood to the brain, where it infects nerve cells and triggers inflammation. Most infections are contained by the immune system, but when the virus crosses the blood-brain barrier it causes encephalitis with swelling, nerve cell damage, and, in severe cases, destruction of brain tissue. The incubation period is 5 to 15 days.
...
\begin{itemize}
    ...
    \item \textbf{Other flaviviruses:} Kunjin and other local viruses
