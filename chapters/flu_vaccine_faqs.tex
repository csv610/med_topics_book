...
\begin{itemize}
    ...
    \item \textbf{Record keeping:} vaccination is recorded on the local Immunisation Register
\end{itemize}

\section*{Management}
\begin{itemize}
    \item \textbf{Where to get it:} GPs, pharmacies, and community immunisation clinics offer the vaccine from around April
    \item \textbf{Who receives funded vaccination:} eligibility varies by country and may include older adults, young children, pregnant people, health workers, and people with chronic medical conditions
