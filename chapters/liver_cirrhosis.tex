...
\begin{itemize}
    ...
    \textbf{Decompensated signs:} Jaundice (yellowing of the skin and sclera due to hyperbilirubinaemia), ascites (tense abdominal swelling from fluid accumulation), and peripheral pitting oedema.
