...
\begin{itemize}
    \item \textbf{Hashimoto's thyroiditis:} the most common cause of hypothyroidism in many countries
...
\begin{itemize}
    ...
    \item \textbf{Newborn screening:} congenital hypothyroidism screening in all local newborns
