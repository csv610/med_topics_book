...
Cognitive impairment and dementia represent major challenges for public health systems globally. In many countries, approximately 400,000 people are currently living with dementia, and this number is expected to double by 2050. The MMSE is one of the most frequently administered cognitive screening tests in local clinical practice. It is widely used by general practitioners, geriatricians, psychiatrists, and neurologists. In many countries, the MMSE plays a specific regulatory role; under the public medicines subsidy (public medicines subsidy), a documented MMSE score is required to establish eligibility and qualify for subsidised prescription of cholinesterase inhibitors (such as donepezil) for patients with Alzheimer's disease.
...
\begin{itemize}
    ...
    \item \textbf{Determining local eligibility:} Under local guidelines, patients must score 10 or more on the MMSE to initiate publicly subsidised cholinesterase inhibitor therapy, and must demonstrate a clinical response or stable score to continue subsidised treatment.
