...
\begin{itemize}
    ...
    \item \textbf{CVD risk:} local absolute CVD risk calculator (age, sex, smoking, BP, cholesterol, diabetes, HDL); consider coronary calcium score if intermediate
...
\section*{Management}
\begin{itemize}
    \item \textbf{Structured care:} GP Management Plan + Team Care Arrangement (public health insurance); annual cycle of care; diabetes educator, dietitian, exercise physiologist, podiatrist, psychologist as needed
    ...
    \begin{itemize}
        ...
        \item \textbf{GLP-1 receptor agonists (semaglutide, dulaglutide, liraglutide, tirzepatide [dual GIP/GLP-1]):} high efficacy (HbA1c -1.0--2.0\%), weight loss (5--15\%), cardiovascular benefit (MACE reduction), renal benefit; injectable (weekly/daily); oral semaglutide available; public medicines subsidy for T2D with HbA1c >7\% on metformin
    ...
    \item \textbf{Technology:} CGM (public medicines subsidy for insulin-treated T2D); smart pens; apps for carb counting, data sharing
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Support:} a local diabetes organisation, NDSS, Diabetes NSW\&ACT / Diabetes Victoria / Diabetes WA / Diabetes SA / Diabetes Queensland / Diabetes Tasmania, local Diabetes Educators Association
\end{itemize}
