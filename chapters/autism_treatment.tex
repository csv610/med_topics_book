...
Because treatment is individualised, the pattern of services used varies widely. Most children diagnosed with ASD in many countries access early intervention therapy, and many are funded through the National Disability Insurance Scheme (national disability-support scheme). Speech pathology and occupational therapy are the most commonly used therapies, often alongside behavioural and psychological support. Coexisting conditions that may need treatment are common: roughly half of autistic people have ADHD symptoms, and anxiety and depression affect many adolescents and adults. Access to services varies by location and income, and waiting lists for assessment and therapy are common, particularly outside major cities.
...
\begin{itemize}
    ...
    \item \textbf{national disability-support scheme planning:} linking the assessment to funded supports
\end{itemize}
