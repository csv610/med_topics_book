...
\begin{itemize}
    ...
    \item \textbf{Public health notification:} Measles is a notifiable disease in many countries; clinicians must immediately report suspected cases to the local public health unit.
\end{itemize}
...
\begin{itemize}
    \item Get vaccinated with two doses of the MMR vaccine, which is the most effective way to prevent measles. In many countries, these are scheduled at 12 and 18 months under the National Immunisation Program.
