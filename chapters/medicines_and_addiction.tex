...
\begin{itemize}
    ...
    \item \textbf{Real-time prescription monitoring (RTPM):} Consultation of national or state databases (such as SafeScript in many countries) to review the patient's prescribing history, identifying multiple prescribers, rapid dispensing, or high-risk drug combinations.
