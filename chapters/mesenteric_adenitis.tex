...
\begin{itemize}
    ...
    \item \textbf{Fever:} Low-to-moderate grade fever (typically between 38$^\circ$C and 39$^\circ$C), which often precedes the onset of abdominal pain.
...
\begin{itemize}
    ...
    \item \textbf{Rest and recovery:} Allowing the child to rest and avoid strenuous physical activities or contact sports until the abdominal pain has resolved.
...
\begin{itemize}
    ...
    \item \textbf{Suppurative lymphadenitis:} A very rare complication where the lymph node undergoes necrosis and forms an abscess, typically associated with specific bacterial infections like \textit{Yersinia}.
