...
\begin{itemize}
    ...
    \item \textbf{Notification:} giardiasis is notifiable in many countries, so cases are reported to public health authorities
\end{itemize}
