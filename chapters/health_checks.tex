...
Health checks are routine medical assessments that look for early signs of disease, risk factors, and opportunities to improve health, in people who feel well or have no concerning symptoms. They include blood pressure and cholesterol measurement, blood glucose and kidney checks, cancer screening, and discussions about lifestyle, vaccination, and mental health. In many countries, the public health insurance Benefits Schedule funds a comprehensive health assessment for people at certain ages and stages, including those aged 45--49 with risk factors and people aged 75 and over. Regular health checks detect problems early, when treatment is most effective, and provide an opportunity to prevent disease.

\section*{Epidemiology}
Many of the leading causes of illness and death in many countries are preventable or detectable early. Around half of adults have high blood pressure or elevated cholesterol, and many do not know it because these conditions cause no symptoms. Heart disease, stroke, type 2 diabetes, and common cancers account for a large share of deaths, and screening reduces their impact. Yet a significant proportion of people have not had a basic health check in the past two years. Regular checks are associated with earlier diagnosis, better risk factor control, and improved outcomes.
...
Everyone should have regular health checks, with the frequency depending on age and risk. public health insurance funds a health assessment for people aged 45--49 with risk factors, and annual assessments for people aged 75 and over. See a doctor sooner for any new or concerning symptoms.
...
\begin{itemize}
    \item Book a health check with your GP, including the publicly funded assessment if you are eligible
