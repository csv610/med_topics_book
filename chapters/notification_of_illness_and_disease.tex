...
the legally required reporting of certain infectious diseases and other public-health conditions to health authorities so outbreaks can be detected and controlled. Individual assessment is important because symptoms and treatment vary with the cause.

\section*{Clinical Features}
There are no symptoms specific to notification; the relevant illness determines the clinical presentation and urgency.
...
Clinicians and laboratories use the applicable state or territory rules and public-health reporting systems; notification does not replace diagnosis or treatment.

\section*{Management}
Provide accurate information, follow isolation and contact-management advice, and protect privacy while cooperating with public-health authorities.
...
Notification of illness and disease is a clinical condition. Interpretation should account for age, baseline health, medicines, comorbidities, goals, and access to care. This chapter supports discussion with a qualified clinician and does not establish a diagnosis.
