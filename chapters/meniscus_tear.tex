...
\begin{itemize}
    ...
    \text{True joint locking:} An inability to fully extend or straighten the knee. This occurs classically with ``bucket-handle'' tears, where a large, displaced fragment of the meniscus flips into the intercondylar notch and physically blocks joint movement.
...
\begin{itemize}
    ...
    \text{Plain radiographs (X-rays):} Recommended to rule out associated bony injuries, fractures, osteochondral lesions, or underlying osteoarthritis, although they cannot directly image the meniscus.
...
\begin{itemize}
    ...
    \text{Surgical risks:} Post-operative joint infection (septic arthritis), deep vein thrombosis (DVT), or damage to local nerves (such as the saphenous nerve during medial meniscal repair).
\end{itemize}
