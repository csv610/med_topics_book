...
Asthma is one of the most common chronic diseases worldwide. Risk and severity vary with family history, allergic disease, tobacco smoke, air pollution, occupational exposure, respiratory infections, and access to effective treatment. Asthma can affect people of any age, and it remains a cause of preventable illness and death when diagnosis or treatment is delayed.
...
\textbf{Contact your local emergency services for an asthma emergency:}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Vaccinations:} keep routine vaccinations up to date; influenza and pneumococcal vaccination may be advised according to age, risk, and local guidance
...
\begin{itemize}
    ...
    \item Keep routine vaccinations up to date and ask whether influenza or pneumococcal vaccination is recommended for your age and risk group
...
\begin{itemize}
    ...
    \item Global Initiative for Asthma. \textit{Global strategy for asthma management and prevention.} https://ginasthma.org/
