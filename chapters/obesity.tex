...
In Australia, 67\% of adults (12.5 million) are overweight or obese (BMI $\ge$25), and 31\% (5.8 million) have obesity (BMI $\ge$30). Severe obesity (Class II/III) affects ~10\% and is rising fastest. Childhood obesity affects 25\% of children (2--17 years). Indigenous Australians have 1.5x higher obesity prevalence. Global obesity has nearly tripled since 1975. Obesity reduces life expectancy by 5--10 years (Class III) and costs the Australian economy >\$11.8 billion annually in direct healthcare and lost productivity. The COVID-19 pandemic highlighted obesity as an independent risk factor for severe outcomes.
...
\begin{itemize}
    ...
    \item \textbf{Cardiovascular risk:} Australian absolute CVD risk calculator; consider coronary calcium score if intermediate risk
...
\begin{itemize}
    ...
    \begin{itemize}
        \item GLP-1 receptor agonists: semaglutide 2.4 mg weekly (STEP trials: -15--17\% weight), liraglutide 3 mg daily (-6--8\%); PBS-listed for T2D; semaglutide 2.4 mg PBS for obesity (BMI $\ge$30 or $\ge$27 with comorbidity) from 2024
        \item Dual GIP/GLP-1: tirzepatide 15 mg weekly (SURMOUNT: -20--25\%); PBS for T2D; obesity listing anticipated
        ...
        \item Phentermine: short-term (12 weeks) only; sympathomimetic; PBS authority required
...
\begin{itemize}
    ...
    \item Follow Australian Dietary Guidelines; limit ultra-processed foods, sugary drinks, alcohol
    ...
    \item Support organisations: Obesity Australia, Obesity Collective, ANZOS, Weight Issues Network
\end{itemize}
