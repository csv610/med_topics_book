...
\begin{itemize}
    \textbf{Tumour lysis syndrome (TLS):} A metabolic emergency caused by the rapid breakdown of cancer cells, leading to hyperkalaemia, hyperuricaemia, hyperphosphataemia, and acute renal failure.
