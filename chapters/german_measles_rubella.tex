...
\begin{itemize}
    ...
    \item \textbf{Notification:} rubella is a notifiable disease in Australia, and cases are reported to public health authorities
\end{itemize}
