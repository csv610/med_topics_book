...
Abortion, also known as termination of pregnancy, is the medical or surgical ending of a pregnancy before birth. In Australia, abortion is lawful in all states and territories, with regulations that vary by jurisdiction in terms of gestational limits and access arrangements. It can be provided using medication alone (medical abortion) or by a procedure (surgical abortion). When performed by trained providers in a legal setting, abortion is a very safe procedure, with serious complications being rare. This chapter explains the methods available, what to expect, the care provided around the procedure, and the situations in which medical help should be sought.

\section*{Epidemiology}
Approximately 1 in 4 Australian women will have an abortion at some point during their reproductive years. The majority of abortions occur in the first trimester, and medical abortion now accounts for more procedures than surgical abortion in many settings. Women seek abortion for a wide range of reasons, including contraceptive failure, risks to maternal health, fetal abnormality, and personal, social, or economic circumstances. Access is generally more straightforward in metropolitan areas than in rural and remote regions, and cost, distance, and availability of providers remain significant barriers for some women.
...
\begin{itemize}
    ...
    \item Children by Choice. \textit{Abortion information and counselling services.} https://www.childrenbychoice.org.au/
\end{itemize}
