...
Bat bites are uncommon compared with bites from dogs and cats, but they are a recognised risk for people who handle bats, such as wildlife carers, vets, and people who find sick or injured bats. In many countries, bats (flying foxes and microbats) can carry the local bat lyssavirus, a close relative of rabies, and a small number of human cases have been reported. Worldwide, bats are a major reservoir of rabies virus. Because bites may go unnoticed (for example, while sleeping), people may not realise they have been exposed.
...
\begin{itemize}
    ...
    \item \textbf{local bat lyssavirus (ABLV):} the relevant virus in many countries, closely related to rabies virus
...
\begin{itemize}
    \item Rabies and local bat lyssavirus encephalitis -- nearly always fatal if symptoms develop; prevention before symptoms is essential
