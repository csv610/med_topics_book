...
terms describing natural variation in brain function and people whose cognitive or sensory processing differs from prevailing expectations, including autism, ADHD, dyslexia, and other profiles. Individual assessment is important because symptoms and treatment vary with the cause.

\section*{Clinical Features}
Differences in attention, communication, learning, sensory processing, movement, or executive function; these are not illnesses by themselves.
...
Assessment is based on developmental history, current functioning, strengths, and support needs; there is no single diagnostic test for neurodiversity.

\section*{Management}
Reasonable adjustments, accessible education or work, occupational or speech therapy when useful, treatment of coexisting conditions, and strengths-based support chosen with the person.
...
Neurodiversity and neurodivergence is a mental-health topic. Interpretation should account for age, baseline health, medicines, comorbidities, goals, and access to care. This chapter supports discussion with a qualified clinician and does not establish a diagnosis.
