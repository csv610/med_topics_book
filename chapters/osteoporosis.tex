...
In many countries, an estimated 1.2 million people have osteoporosis (T-score $\le$--2.5) and 6.3 million have osteopenia (T-score --1.0 to --2.5). One in three women and one in five men over 50 will sustain an osteoporotic fracture. Hip fracture incidence is ~20,000/year; vertebral fractures are more common but often undiagnosed. Fracture risk increases exponentially with age; women lose bone rapidly after menopause (10-year accelerated loss). Indigenous people have lower BMD but higher fracture rates at younger ages. Annual cost exceeds \$3.8 billion. Despite effective treatments, a ``treatment gap'' persists: <30\% of high-risk patients receive therapy.
...
\begin{itemize}
    ...
    \item \textbf{Fracture risk calculators:} FRAX (10-year major osteoporotic and hip fracture probability); Garvan Fracture Risk Calculator (includes falls history); local FRAX model available
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{First-line:} Oral bisphosphonates (alendronate 70 mg weekly, risedronate 35 mg weekly); IV zoledronic acid 5 mg annually (if oral intolerant/contraindicated); local eligibility criteria: T-score $\le$--2.5 + age $\ge$70, or fragility fracture, or glucocorticoid use
        ...
        \item \textbf{Anabolic agents (high fracture risk, severe osteoporosis, failed antiresorptives):} Teriparatide 20 $\mu$g SC daily $\times$ 24 months (public medicines subsidy: $\ge$2 fragility fractures, one hip/spine, T-score $\le$--3.0); Romosozumab 210 mg SC monthly $\times$ 12 months (public medicines subsidy: similar criteria) followed by antiresorptive
...
\begin{itemize}
    ...
    \item Join support: Healthy Bones some countries, a local osteoporosis organisation
\end{itemize}
