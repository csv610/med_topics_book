...
\begin{itemize}
    ...
    \item Suspected overdose or deliberate self-harm with medicines -- also contact the Poisons Information Centre on 13 11 26 (Australia) for advice
...
\begin{itemize}
    ...
    \item \textbf{Reporting:} serious or unexpected reactions can be reported to the national medicines regulator (the TGA in Australia)
\end{itemize}
