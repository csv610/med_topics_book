...
\textbf{Contact your local emergency services or attend an emergency department for (myasthenic crisis):}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Support:} patient organisations (MG Association of the affected region) provide education and peer support
\end{itemize}
