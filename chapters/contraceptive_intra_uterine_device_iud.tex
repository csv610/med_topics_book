...
The clinical utilisation of IUDs has increased substantially worldwide and within Australia over the last two decades. Currently, IUDs are recommended by major medical bodies as first-line contraceptive options for women of all reproductive ages, including nulliparous women and adolescents. In Australia, the uptake of hormonal IUDs has been particularly strong, supported by their listing on the Pharmaceutical Benefits Scheme (PBS). Approximately 6\% to 10\% of Australian women of reproductive age use an IUD, with hormonal devices representing the vast majority of these cases. Efficacy rates are virtually identical in real-world clinical use compared to clinical trials due to the user-independent nature of the device.
...
\begin{itemize}
    ...
    \textbf{Pain and spasm management:} Suggesting pre-procedure NSAIDs (e.g., ibuprofen) to reduce uterine cramping, and ensuring the patient has a resting period immediately post-insertion.
