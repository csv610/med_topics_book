...
\textbf{Immediate help is also available} from a local crisis line, urgent mental-health service, or the nearest emergency department. Crisis-line numbers vary by country.
...
\begin{itemize}
    ...
    \item \textbf{Tapering:} stopping is usually planned gradually with the prescriber to reduce withdrawal symptoms, although urgent medical circumstances may require a different plan
...
\begin{itemize}
    ...
    \item World Health Organization. \textit{Mental health.} https://www.who.int/health-topics/mental-health
