...
\index{Adrenaline Autoinjector: How to Use It}
...
seek emergency help immediately if anaphylaxis is suspected, even if the autoinjector is used and symptoms improve. Adrenaline is first aid only, and hospital observation is always required because a second wave of symptoms can occur hours later.
...
\begin{itemize}
    ...
    \item Contact your local emergency services, keep the person lying flat with their legs raised (or sitting up if they are struggling to breathe), and watch them closely
