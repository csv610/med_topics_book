...
\begin{itemize}
    ...
    \text{\item \textbf{Histamine-driven vasodilation:}} Histamine release causes rapid capillary dilation, increased vascular permeability, and stimulation of local pruriceptive nerve fibres, resulting in the immediate formation of an itchy wheal (hive).
...
\begin{itemize}
    ...
    \text{\item \textbf{Encephalitic viral symptoms:}} High fever, severe headache, neck stiffness, photophobia, confusion, and altered mental state indicating central nervous system infection.
\end{itemize}
...
\begin{itemize}
    ...
    \text{\item \textbf{Oral antibiotics:}} Prescribing a course of cephalexin or flucloxacillin if a bite site develops secondary bacterial cellulitis or impetigo due to scratching.
