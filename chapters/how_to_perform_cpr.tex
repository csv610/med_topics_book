...
Cardiopulmonary resuscitation (CPR) is a life-saving first aid technique used when someone's heart has stopped or they are not breathing. CPR combines chest compressions, which manually pump blood to the brain and vital organs, with rescue breaths that provide oxygen. Starting CPR immediately can double or triple a person's chance of survival after cardiac arrest. The current local recommendation is compressions at a rate of 100--120 per minute, to a depth of about 5 cm in adults, with minimal interruption. Everyone can learn CPR, and doing something is always better than doing nothing.

\section*{Epidemiology}
Around 20,000--30,000 people suffer an out-of-hospital cardiac arrest each year, and survival is only around 10\%. Bystander CPR is the single most important factor in survival: it is performed in only about half of witnessed arrests, and increasing bystander CPR rates would save hundreds of lives annually. Survival falls by about 10\% for every minute without CPR or defibrillation. Community CPR training and publicly accessible defibrillators (AEDs) have improved outcomes in many areas.
...
Contact your local emergency services immediately for any unresponsive person who is not breathing normally, put the phone on speaker, and follow the dispatcher's instructions.
...
\begin{itemize}
    ...
    \item \textbf{Call for help:} send someone to contact local emergency services and fetch an AED
...
\begin{itemize}
    ...
    \item Recognise the warning signs of heart attack and contact local emergency services early
    ...
    \item Stay updated with local Resuscitation Council guidelines
