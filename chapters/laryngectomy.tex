...
\begin{itemize}
    ...
    \item \textbf{Radiation necrosis:} Chronic, progressive tissue death and chondroradionecrosis of the laryngeal cartilage following high-dose radiotherapy for head and neck cancers, resulting in a non-functional, painful, or obstructed larynx.
...
\begin{itemize}
    ...
    \item \textbf{Dysphagia and odynophagia:} Difficulty and pain when swallowing, often indicating tumour spread into the piriform sinuses, hypopharynx, or base of the tongue.
    ...
    \item \textbf{Cachexia and weight loss:} Significant, unintended weight loss due to a combination of swallowing difficulties and tumour-induced systemic inflammatory state.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Mucus plugging and crusting:} Accumulation of thick, dry tracheal secretions that can block the airway, particularly in the immediate post-operative period.
