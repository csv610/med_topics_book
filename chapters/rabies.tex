...
Rabies is a viral infection of the nervous system, usually transmitted through saliva from an infected mammal bite or scratch. Wash any wound thoroughly and obtain urgent post-exposure prophylaxis. Once symptoms develop, rabies is almost always fatal, so prevention must not be delayed.
...
This chapter addresses rabies, a topic that should be interpreted in the context of age, baseline health, medicines, comorbidities, goals, and access to care. It supports discussion with a qualified clinician and does not establish a diagnosis.
