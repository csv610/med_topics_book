...
Melioidosis, also known as Whitmore's disease, is a severe infection caused by the environmental bacterium \textit{Burkholderia pseudomallei}. The organism lives in soil and surface water in tropical and subtropical regions. Disease can range from a localised skin infection or pneumonia to rapidly progressive septicaemia and organ failure. Diabetes, hazardous alcohol use, kidney or lung disease, thalassaemia, and immunosuppression increase risk.

\section*{Epidemiology}
Melioidosis is endemic in parts of Southeast Asia, northern Australia, South Asia, and other tropical regions. Cases often increase during wet seasons when heavy rain brings contaminated soil and water to the surface. It can affect any age group, but risk is greatest with relevant medical conditions and occupational or recreational exposure to soil or muddy water.
