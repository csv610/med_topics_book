...
Peritonsillar Abscess is an infectious condition caused by a specific organism or group of organisms. The route of acquisition, severity, and treatment depend on the organism and the person's immune status.
...
This chapter addresses peritonsillar abscess, a topic that should be interpreted in the context of age, baseline health, medicines, comorbidities, goals, and access to care. It supports discussion with a qualified clinician and does not establish a diagnosis.
