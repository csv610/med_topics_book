...
Diabetes affects around 1 in 10 Australians, and the HbA1c test is central to its diagnosis and management. Around 5--10% of Australians have HbA1c levels in the prediabetes range, indicating an increased risk of developing diabetes. The test is also used to monitor the effectiveness of treatment in the millions of Australians with type 1 and type 2 diabetes. Because HbA1c does not require fasting, it is convenient and widely used in both laboratory and point-of-care settings.
...
\begin{itemize}
    ...
    \item \textbf{Diagnosis:} an HbA1c of 6.5% (48 mmol/mol) or higher diagnoses diabetes; 6.0--6.4% indicates prediabetes in Australian guidelines
