...
\begin{itemize}
    ...
    \item \textbf{Disability support and funding:} Navigating social support services, such as the National Disability Insurance Scheme (national disability-support scheme) in many countries, to fund therapy, support workers, and assistive technology.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Preconceptional and prenatal care:} Taking folic acid, avoiding alcohol, tobacco, and illicit drugs during pregnancy, and keeping up to date with maternal immunisations.
