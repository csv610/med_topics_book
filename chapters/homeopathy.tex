...
Homeopathy is used by a small but significant minority of people in Australia, often alongside conventional medicine. Around 2--5\% of Australians have used homeopathic remedies, with higher use among those interested in natural therapies and among parents treating children. Australians spend millions of dollars annually on homeopathic products. Use is higher in Europe, where homeopathy has a long tradition. Most use is for minor, self-limiting conditions such as colds, allergies, and anxiety, and most people also use conventional care.
...
\begin{itemize}
    ...
    \item \textbf{Regulation:} in Australia, homeopathic products are regulated as medicines by the TGA, but efficacy is not evaluated for most products
