...
\begin{itemize}
    ...
    \item \textbf{Seizures:} New-onset focal or generalised seizures, resulting from local cortical irritation by the tumour.
...
\begin{itemize}
    ...
    \item \textbf{Surgical complications:} Intracranial haemorrhage, surgical site infection, cerebrospinal fluid (CSF) leak, venous thromboembolism, or damage to adjacent cranial nerves.
    ...
    \item \textbf{Epilepsy:} Persistent seizure disorders requiring long-term anticonvulsant therapy.
\end{itemize}
