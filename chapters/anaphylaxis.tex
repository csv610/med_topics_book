...
\section*{Management}
\begin{itemize}
    \item \textbf{Emergency first aid:} give adrenaline promptly if an autoinjector is available, contact your local emergency services, and keep the person lying flat unless breathing is easier sitting up. Do not let the person stand or walk suddenly.
    \item \textbf{Adrenaline:} it is the first-line treatment and should be injected into the outer thigh according to the device instructions. A second dose may be needed if symptoms do not improve or return; follow local emergency guidance.
    \item \textbf{Hospital care:} clinicians support the airway, breathing, and circulation, give oxygen and intravenous fluids when needed, and observe for recurrence. Antihistamines do not treat airway swelling or shock, and corticosteroids are not substitutes for adrenaline.
