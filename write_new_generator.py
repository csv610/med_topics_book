#!/usr/bin/env python3
"""Write the new 11-section generator to generate_all_chapters.py"""

import os

NEW_FILE = '''#!/usr/bin/env python3
"""
...
with open(os.path.join(HERE if 'HERE' in dir() else '.', "generate_all_chapters.py"), "w") as f:
    f.write(NEW_FILE)
print("Wrote generate_all_chapters.py")
